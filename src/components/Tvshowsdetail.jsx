...
function Tvshowsdetail() {
  ...
  return info && info.detail  ? (
    <div className="md:min-h-[100vh] h-[205vh] w-screen bg-zinc-800 mb-[2%]">
      <img
      ...
      <h1 className="italic font-semibold mt-5 md:mt-0 md:text-3xl">OverView</h1>
      <p className="hidden md:block italic font-light text-lg w-[70%]">{info.detail.overview.slice(0,250)} ...</p>
...
<div className=" w-[100%] flex  overflow-x-auto  gap-4 overflow-y-hidden">
     ...
     {(info.detail.seasons.map((elem,index)=>{
      ...
      <div className="absolute top-[64vh] md:top-[52vh] left-[14vw] md:left-[18vw] mt-10 gap-8 w-[80%]">
        ...
        <div className="md:w-[50%] h-[10%]  flex items-center gap-2  pb-10">
